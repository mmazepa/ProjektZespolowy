...
@WebServlet("/doEditWorkgroupByUser")
public class WorkgroupUpdaterByUser extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    System.out.println("SUCCESS UPDATE   Workgroup        "+ipAddress+"\t"+commitdate+"");
			...
			response.sendRedirect("/subpages/userActions/updateSuccessByUser.jsp");
	    ...
	    System.out.println("FAIL    UPDATE   Workgroup        "+ipAddress+"\t"+commitdate+"");
			...
			response.sendRedirect("/subpages/userActions/updateFailByUser.jsp");
		} finally {
			db.doTranEnd();
		}
	}
